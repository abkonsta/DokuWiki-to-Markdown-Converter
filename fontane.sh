...
wget "$WIKI?id=fontane:testdatei&do=export_raw&$CRED" &&
...
perl-rename "s/doku.php\?id=fontane:(.*)\&do\=export_raw\&u\=fontane-test\&p=VYZg18ITNFB59y3mEz8bCQ/\1.txt/" doku.php*
grep -l "\\" | xargs sed -i "s/\\\\/\<br\/\>/g"
cd ..
